"""
Django settings for studdiebudiebackend project.
...
ALLOWED_HOSTS = [
    '*',
    'studdiebudie.pythonanywhere.com',
    ]
...
ROOT_URLCONF = 'studdiebudiebackend.urls'
...
WSGI_APPLICATION = 'studdiebudiebackend.wsgi.application'
